...
export default async function AdminServicesPage() {
  ...
  return <main className="admin-main content-shell"><header className="admin-page-header"><div><p className="admin-eyebrow">Catalogue</p><h1 className="admin-title">Prestations</h1><p>Consultez, classez et publiez les soins proposés par l’institut.</p></div><div className="admin-page-actions"><Link className="admin-button secondary" href="/admin/prestations/categories/nouvelle">Nouvelle catégorie</Link><Link className="admin-button primary" href="/admin/prestations/nouvelle">Nouvelle prestation</Link></div></header>
