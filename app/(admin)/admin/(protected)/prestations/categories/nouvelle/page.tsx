...
export default async function NewServiceCategoryPage() {
  ...
  return <main className="admin-main content-shell admin-form-page"><header><p className="admin-eyebrow">Catalogue</p><h1 className="admin-title">Nouvelle catégorie</h1><p>Ajoutez un nouvel univers pour classer les prestations.</p></header><ServiceCategoryForm /></main>;
}
