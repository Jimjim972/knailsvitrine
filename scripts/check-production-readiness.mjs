...
export const PROFILE_COMMANDS = Object.freeze({
  local: [
    ...
    { id: "unit-contact", command: "npm", args: ["run", "test:unit:contact"], requirementIds: ["FR-045", "FR-050", "SC-009", "SC-011"] },
    {
      id: "foundation",
      command: "npm",
      args: ["run", "foundation:check"],
      env: { KN_PRODUCTION_READINESS_ORCHESTRATOR: "true" },
      requirementIds: FEATURE_REQUIREMENTS("001", 10),
    },
    ...
    { id: "contact", command: "npm", args: ["run", "contact:check"], requirementIds: [...FEATURE_REQUIREMENTS("005", 10), "FR-050", "SC-011"] },
    {
      ...
      env: {
        KN_PLAYWRIGHT_SUITE: "seo",
        KN_SEO_PROFILE: "preview",
        PLAYWRIGHT_BASE_URL: "http://127.0.0.1:3000",
      },
      requirementIds: [...RANGE("FR", 13, 20), "SC-003"],
    },
