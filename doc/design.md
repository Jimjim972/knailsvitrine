...
La page Prestations présente trois actions adjacentes : « Catégories » et « Nouvelle catégorie » en style secondaire, puis « Nouvelle prestation » en style principal. Elles passent sur toute la largeur et s’empilent à 768 px et moins ; cette exception administrative au breakpoint principal de 760 px évite tout débordement à la largeur de contrôle obligatoire. La page Catégories reprend la liste administrative en cartes : nom, nombre de prestations, ordre, actions « Modifier » et « Supprimer », avec retour vers les prestations et création en en-tête. Le formulaire de catégorie reprend les mêmes champs, erreurs, annonces, état pending et actions Annuler/Créer ou Annuler/Enregistrer que les autres formulaires administratifs. La suppression ouvre un dialogue titré, nomme la catégorie, restaure le focus à l’annulation et avertit lorsqu’elle contient encore des prestations ; la confirmation est refusée côté serveur tant qu’une référence existe. Le formulaire de prestation propose un lien textuel « Créer une nouvelle catégorie » sous son sélecteur ; s’il n’existe aucune catégorie, le sélecteur et la soumission restent désactivés avec une consigne explicite.
