...
test("visitors are redirected from every services administration deep link", async ({ page }) => {
  for (const path of ["/admin/prestations", "/admin/prestations/nouvelle", "/admin/prestations/categories", "/admin/prestations/categories/nouvelle", "/admin/prestations/categories/onglerie_manucure/modifier", "/admin/prestations/31000000-0000-4000-8000-000000000001/modifier"]) {
